/******/ (() => {
  ...
  \*************************************************/
      /***/ (
        ...
        /* harmony import */ var _weather__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./weather */ "./src/modules/weather.js");
        /* harmony import */ var _full_weather__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./full-weather */ "./src/modules/full-weather.js"
          );
        /* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! ./utils */ "./src/modules/utils.js");
        /* harmony import */ var _openWeatherMapInterface__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! ./openWeatherMapInterface */ "./src/modules/openWeatherMapInterface.js"
          );
        /* harmony import */ var _alert__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(/*! ./alert */ "./src/modules/alert.js");
        ...
        /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
          ...
          function mapAlert(openWeatherMapAlertObj) {
            const alertObj = new _alert__WEBPACK_IMPORTED_MODULE_4__[
              "default"
            ]();
            alertObj.senderName = openWeatherMapAlertObj.sender_name;
            alertObj.event = openWeatherMapAlertObj.event;
            alertObj.start = (0,
            _utils__WEBPACK_IMPORTED_MODULE_2__.unixUTCToDate)(
              openWeatherMapAlertObj.start
            );
            alertObj.end = (0,
            _utils__WEBPACK_IMPORTED_MODULE_2__.unixUTCToDate)(
              openWeatherMapAlertObj.end
            );
          ...
          function mapWeatherObj(openWeatherObj) {
            const weatherObj = new _weather__WEBPACK_IMPORTED_MODULE_0__[
              "default"
            ]();
            weatherObj.date = (0,
            _utils__WEBPACK_IMPORTED_MODULE_2__.unixUTCToDate)(
            ...
            _utils__WEBPACK_IMPORTED_MODULE_2__.unixUTCToDate)(
              openWeatherObj.sunrise
            );
            weatherObj.sunset = (0,
            _utils__WEBPACK_IMPORTED_MODULE_2__.unixUTCToDate)(
              openWeatherObj.sunset
            );
            ...
            weatherObj.rainChance = (0,
            _utils__WEBPACK_IMPORTED_MODULE_2__.toPercent)(openWeatherObj.pop);
            return weatherObj;
          }

          function mapFullWeather(openWeatherMapObj) {
            const weatherObj = new _full_weather__WEBPACK_IMPORTED_MODULE_1__[
              "default"
            ]();
            ...
            // current weather
            weatherObj.currentWeather = mapWeatherObj(
              openWeatherMapObj.current
            );
          ...
          function mapCurrentWeather(openWeatherMapObj) {
            ...
            weatherObj.date = (0,
            _utils__WEBPACK_IMPORTED_MODULE_2__.unixUTCToDate)(
              openWeatherMapObj.dt
            );

            weatherObj.sunrise = (0,
            _utils__WEBPACK_IMPORTED_MODULE_2__.unixUTCToDate)(
              openWeatherMapObj.sys.sunrise
            );
            weatherObj.sunset = (0,
            _utils__WEBPACK_IMPORTED_MODULE_2__.unixUTCToDate)(
              openWeatherMapObj.sys.sunset
            );
          ...
          async function getWeather(keywords) {
            let currentWeatherResponse =
              await _openWeatherMapInterface__WEBPACK_IMPORTED_MODULE_3__[
                "default"
              ].getCurrentWeather(keywords);
            if (
            ...
            const fullWeatherResponse =
              await _openWeatherMapInterface__WEBPACK_IMPORTED_MODULE_3__[
                "default"
              ].getFullWeather(weatherObj.latitude, weatherObj.longitude);

            console.log(fullWeatherResponse);
            console.log(
              _openWeatherMapInterface__WEBPACK_IMPORTED_MODULE_3__[
                "default"
              ].getWeatherIcon(weatherObj.iconID)
            );
  ...
  \******************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ celsiusToFahrenheit: () =>
            /* binding */ celsiusToFahrenheit,
          /* harmony export */ celsiusToKelvin: () =>
            /* binding */ celsiusToKelvin,
          /* harmony export */ fahrenheitToCelsius: () =>
            /* binding */ fahrenheitToCelsius,
          /* harmony export */ fahrenheitToKelvin: () =>
            /* binding */ fahrenheitToKelvin,
          /* harmony export */ kelvinToCelsius: () =>
            /* binding */ kelvinToCelsius,
          /* harmony export */ kelvinToFahrenheit: () =>
            /* binding */ kelvinToFahrenheit,
          /* harmony export */
        });
        /**
          ...
          getTemp(kelvin, unit) {
            switch (unit) {
              case unit.startsWith("C"):
                return (0, _utils__WEBPACK_IMPORTED_MODULE_0__.kelvinToCelsius)(
                  kelvin
                );
              case unit.startsWith("F"):
                return (0,
                _utils__WEBPACK_IMPORTED_MODULE_0__.kelvinToFahrenheit)(kelvin);
              default:
                return kelvin;
            }
          }
  ...
  \***************************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ formatTimezone: () =>
            /* binding */ formatTimezone,
          /* harmony export */
        });
        var token =
  ...
  \**********************/
    __webpack_require__.r(__webpack_exports__);
    /* harmony import */ var dateformat__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(
        /*! dateformat */ "./node_modules/dateformat/lib/dateformat.js"
      );
    /* harmony import */ var _modules_openWeatherMapInterface__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(
        /*! ./modules/openWeatherMapInterface */ "./src/modules/openWeatherMapInterface.js"
      );
    /* harmony import */ var _modules_openWeatherMapController__WEBPACK_IMPORTED_MODULE_2__ =
      __webpack_require__(
        /*! ./modules/openWeatherMapController */ "./src/modules/openWeatherMapController.js"
      );
    /* harmony import */ var _modules_utils__WEBPACK_IMPORTED_MODULE_3__ =
    ...
    async function test() {
      ...
      try {
        const weatherObj =
          await _modules_openWeatherMapController__WEBPACK_IMPORTED_MODULE_2__[
            "default"
          ].getWeather(city);
        console.log(weatherObj);
      } catch (error) {
